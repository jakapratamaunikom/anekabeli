				...
				<header id="topNav">
					<div class="container">
							...
							<li class="quick-cart">
								...
								<div class="quick-cart-box">
									...
									<div class="quick-cart-wrapper">
										...
										<a href="#"><!-- cart item -->
											<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/4-min.jpg" width="45" height="45" alt="" />
											<h6><span>2x</span> RED BAG WITH HUGE POCKETS</h6>
											<small>$37.21</small>
										</a><!-- /cart item -->

										<a href="#"><!-- cart item -->
											<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/5-min.jpg" width="45" height="45" alt="" />
						...
						<a class="logo pull-left" href="<?php echo base_url(); ?>">
							<img src="<?php echo base_url(); ?>assets/user/assets/images/logo_dark.png" alt="" />
						</a>
										...
										<ul class="dropdown-menu">
											...
											<li class="dropdown active">
												...
												<ul class="dropdown-menu">
													...
													<li class="active"><a href="blog-column-aside-right.html">RIGHT SIDEBAR</a></li>
												</ul>
											</li>
											<li class="dropdown">
												<a class="dropdown-toggle" href="#">
