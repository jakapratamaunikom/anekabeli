					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-9">
							...
							<figure class="margin-bottom-20">
								<img class="img-responsive" src="<?php echo base_url(); ?>assets/user/assets/images/demo/content_slider/21-min.jpg" alt="img" />
							</figure>
							<!-- /IMAGE -->
							...
							<div id="comments" class="comments">
								...
								<div class="comment-item">
									...
									<span class="user-avatar">
										<img class="pull-left media-object" src="<?php echo base_url(); ?>assets/user/assets/images/avatar.png" width="64" height="64" alt="">
									</span>
								...
								<div class="comment-item">
									...
									<!-- user-avatar -->
									<span class="user-avatar">
										<img class="media-object" src="<?php echo base_url(); ?>assets/user/assets/images/avatar.png" width="64" height="64" alt="">
									</span>
								...
								<div class="tab-content margin-bottom-60 margin-top-30">
									...
									<div id="tab_1" class="tab-pane active">
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/1-min.jpg" width="50" alt="" />
												</a>
											</div>
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/2-min.jpg" width="50" alt="" />
												</a>
											</div>
											<div class="col-md-9 col-sm-9 col-xs-9">
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/3-min.jpg" width="50" alt="" />
												</a>
											</div>
											<div class="col-md-9 col-sm-9 col-xs-9">
									...
									<div id="tab_2" class="tab-pane">
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/4-min.jpg" width="50" alt="" />
												</a>
											</div>
											<div class="col-md-9 col-sm-9 col-xs-9">
												<a href="blog-sidebar-left.html" class="tab-post-link">Curabitur pellentesque neque eget diam</a>
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/5-min.jpg" width="50" alt="" />
												</a>
											</div>
											<div class="col-md-9 col-sm-9 col-xs-9">
												<a href="blog-sidebar-left.html" class="tab-post-link">Maecenas metus nulla</a>
										...
										<div class="row tab-post"><!-- post -->
											<div class="col-md-3 col-sm-3 col-xs-3">
												<a href="blog-sidebar-left.html">
													<img src="<?php echo base_url(); ?>assets/user/assets/images/demo/people/300x300/6-min.jpg" width="50" alt="" />
												</a>
											</div>
											<div class="col-md-9 col-sm-9 col-xs-9">
